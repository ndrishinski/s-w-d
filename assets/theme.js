  ...
  theme.predictiveSearch = (function() {
      ...
      if (collections.length) {
        ...
        output = `
          <div data-type-collections>
            <p class="predictive__label">${theme.strings.searchCollections}</p>
            <ul class="no-bullets">
              ${markup}
            </ul>
          </div>
    ...
    function buildPages(pages) {
      ...
      if (pages.length) {
        ...
        output = `
          <div data-type-pages>
            <p class="predictive__label">${theme.strings.searchPages}</p>
            <ul class="no-bullets">
              ${markup}
            </ul>
          </div>
      ...
      if (articles.length) {
        ...
        output = `
          <div data-type-articles>
            <p class="predictive__label">${theme.strings.searchArticles}</p>
            <div class="grid grid--uniform">
              ${markup}
            </div>
          </div>
